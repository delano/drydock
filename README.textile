...
Forked from "bmizerany-frylock":http://github.com/bmizerany/frylock/tree

h3. Overview

Ruby + CLI + DSL = Command line apps made easy! 
...
git clone git://github.com/delano/frylock.git
